...
public interface NettoyageRepository extends JpaRepository<Nettoyage,Integer>,NettoyageRepositoryCustom {

    @Query(value = "SELECT n FROM Nettoyage n WHERE concat(n.date,n.typeNettoyage,n.etatNettoyage) LIKE %?1% ", nativeQuery = false)
    Page<Nettoyage> findByKeyword(String keyword,Pageable pageable);
